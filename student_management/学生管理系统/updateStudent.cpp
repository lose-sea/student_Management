        ...
        switch (mark) {
            ...
            case '1': {
                ...
                while (1) {
                    ...
                    if (findByid(stu, id) == NULL || strcmp(curr->id, id) == 0) {
                        break;
                    } else {
                        printf("已存在该学号, 请重新输入: ");
                        Sleep(600);
            ...
            case '7': {
                ...
                double Math_score;
                while (1) {
                    int judgescore = scanf("%lf", &Math_score);
                    clearInputBuffer();
                    if (judgescore != 1 || Math_score < 0 || Math_score > 100) {
                        printf("输入错误,请重新输入\n");
                        Sleep(2000);
                        printf("\033[1A");    // 光标上移一行  
                        printf("\033[2K");    // 清除整行  
            ...
            case'8': {
                ...
                while (1) {
                    int judgescore = scanf("%lf", &History_score);
                    clearInputBuffer();
                    if (judgescore != 1 || History_score < 0 || History_score > 100) {
                        printf("输入错误,请重新输入\n");
                        Sleep(800);
                        printf("\033[1A");    // 光标上移一行  
                        printf("\033[2K");    // 清除整行  
                        ...
                        curr->History = History_score;
                        break;
                    }
                }
                printf("已将近代史成绩修改为 %.2lf \n", History_score);
                system("pause");
                break;
            } 
            case'9': {
                ...
                double Eng_score;
                while (1) {
                    int judgescore = scanf("%lf", &Eng_score);
                    clearInputBuffer();
                    if (judgescore != 1 || Eng_score < 0 || Eng_score > 100) {
                        printf("输入错误,请重新输入\n");
                        Sleep(800);
                        printf("\033[1A");    // 光标上移一行  
                        printf("\033[2K");    // 清除整行  
                        ...
                        curr->English = Eng_score;
                        break;
                    }
                }
                printf("已将英语成绩修改为 %.2lf \n", Eng_score);
                system("pause");
                break;
            }
            case 'A': 
